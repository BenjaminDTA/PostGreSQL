...
public class Main {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			...
			stmt.executeUpdate("CREATE TABLE book(id serial PRIMARY KEY, " 
			...
			stmt.executeUpdate("CREATE TABLE achat(id_client Integer, id_book Integer, constraint fk_id_achat FOREIGN KEY (id_book) references book(id), constraint fk_id_achat2 FOREIGN KEY (id_client) references client(id))");
